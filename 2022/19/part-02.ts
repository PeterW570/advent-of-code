...
for (const blueprint of blueprints) {
	...
	console.log(`Blueprint ${blueprint.id} / ${blueprints.length}: ${maxGeodes} geodes`);
	maxGeodeProduct *= maxGeodes;
}

console.log(maxGeodeProduct);
